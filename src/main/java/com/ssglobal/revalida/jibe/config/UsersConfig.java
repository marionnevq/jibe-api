    ...
    CommandLineRunner commandLineRunnerUsers(UserRepository userRepository, PostRepository postRepository,
        ...
        return args -> {
            User user1 = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(14496))
                    .age(39)
            ...
            User user2 = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(13659))
                    .age(37)
            ...
            User jim = User.builder()
                    ...
                    .bio("Kung ayaw mong mainlove ng todo\r\n"
                    		...
                    		+ "")
                    .birthday(LocalDate.now().minusDays(8507))
                    .age(23)
            ...
            User mars = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(8563))
                    .age(23)
            ...
            User nikki = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(8320))
                    .age(22)
            ...
            User jayann = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(8473))
                    .age(23)
            ...
            User u6 = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(11180))
                    .age(30)
            ...
            User u7 = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(9596))
                    .age(26)
            ...
            User u8 = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(9335))
                    .age(25)
            ...
            User u9 = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(10593))
                    .age(29)
            ...
            User u10 = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(9981))
                    .age(27)
            ...
            User u11 = User.builder()
                    ...
                    .birthday(LocalDate.now().minusDays(9188))
                    .age(25)
            ...
            User u12 = User.builder()
                    ...
                    .bio("Wait For Me.")
                    .birthday(LocalDate.now().minusDays(10714))
                    .age(29)
            ...
            User u13 = User.builder()
                    ...
                    .bio("Wait For Me.")
                    .birthday(LocalDate.now().minusDays(10887))
                    .age(29)
            ...
            User u14 = User.builder()
                    ...
                    .bio("Hey, It's Quen.")
                    .birthday(LocalDate.now().minusDays(11294))
                    .age(30)
                    .imageUrl("https://i.mydramalist.com/RlzvR_5f.jpg")
                    .firstTimeLogin(false)
                    .role(Role.USER)
